...
namespace MesajCore.Data.Migrations
{
    ...
    [Migration("20190403093052_kurulum")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MesajCore.Models.Mesaj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MesajCore.Models.Person", b =>
                {
            ...
            modelBuilder.Entity("MesajCore.Models.Mesaj", b =>
                {
                    b.HasOne("MesajCore.Models.Person", "Alici")
                        .WithMany("AlinanMesajlar")
                        .HasForeignKey("AliciId");

                    b.HasOne("MesajCore.Models.Person", "Gonderen")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MesajCore.Models.Person")
                        .WithMany()
